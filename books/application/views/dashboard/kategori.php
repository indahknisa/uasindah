        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo anchor('book/editKategori/'.$kategori_item['idkategori'], 'Edit', 'Edit Kategori'); ?> |
              <?php echo anchor('Book/deleteKategori/'.$kategori_item['idkategori'], 'Del', 'Hapus Kategori'); ?>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
